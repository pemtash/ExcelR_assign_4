delivery_time <- read.csv("C:\\Users\\user\\Desktop\\EXCELR ASSIGNMENT\\ASSIGNMENT\\assignment4 simple_linear_regression\\delivery_time.csv")
View(delivery_time)
...
confint(reg,level=0.95)# confidence interval at 95%
...
pred2
View(pred2)
wc.at <- read.csv("C:\\Users\\user\\Desktop\\EXCELR ASSIGNMENT\\ASSIGNMENT\\assignment4 simple_linear_regression\\wc-at.csv")
